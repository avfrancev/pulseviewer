...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Decoder } from './src/modules/PulsesViewer/models/MeasurementDecoders'
  import('./src/modules/PulsesViewer/models/MeasurementDecoders')
  // @ts-ignore
  export type { Measurement, MeasurementStorage } from './src/modules/PulsesViewer/models/Measurements'
  import('./src/modules/PulsesViewer/models/Measurements')
  // @ts-ignore
  export type { PulsesStore } from './src/modules/PulsesViewer/models/PulseStore'
  import('./src/modules/PulsesViewer/models/PulseStore')
  // @ts-ignore
  export type { Pulses, PulsesItem, PulsesStorage } from './src/modules/PulsesViewer/models/Pulses'
  import('./src/modules/PulsesViewer/models/Pulses')
  // @ts-ignore
  export type { FormatType, IParsedPulses, ParsedType2 } from './src/modules/PulsesViewer/parserHelpers'
  import('./src/modules/PulsesViewer/parserHelpers')
  // @ts-ignore
  export type { IAnalyzerWorkerArgs, IAnalyzerWorkerResult, ISliceGuessResult, HintsGroups, BitsHints, IBitsHintsGroup, Hint } from './src/modules/PulsesViewer/workers/analyzer.worker'
  import('./src/modules/PulsesViewer/workers/analyzer.worker')
  // @ts-ignore
  export type { ToastType, Toast } from './src/composables/useToast'
  import('./src/composables/useToast')
  // @ts-ignore
  export type { ZoomTransform, IViewConstrains, IViewArgs, IView } from './src/composables/usePanZoom'
  import('./src/composables/usePanZoom')
}
