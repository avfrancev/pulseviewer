...
<template>
  <svg
    class="absolute inset-0 w-full overflow-hidden pointer-events-none select-none touch-none -z-10 fill-slate-700/30"
  ...
  >
    ...
    >
      <div
        v-for="t in ticks"
        :key="t"
        class="absolute top-0 text-xs -translate-x-1/2"
